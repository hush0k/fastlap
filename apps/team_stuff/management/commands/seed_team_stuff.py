...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs) ->None:
        team_stuff = [
            {"first_name": "Christian", "last_name": "Horner", "country": "GB", "role": "Team Principal"},
            {"first_name": "Toto", "last_name": "Wolff", "country": "AT", "role": "Team Principal"},
            {"first_name": "Frederic", "last_name": "Vasseur", "country": "FR", "role": "Team Principal"},
            {"first_name": "Adrian", "last_name": "Newey", "country": "GB", "role": "Chief Technical Officer"},
        ]
        stuff_objects = []
