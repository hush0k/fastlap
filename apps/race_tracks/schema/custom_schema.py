...
class RaceTrackAutoSchema(AutoSchema):
    def _map_serializer(self, serializer, direction, bypass_extensions=False):
        ...
        if hasattr(serializer_instance, "Meta") and hasattr(
            serializer_instance.Meta, "model"
        ):
        ...
        return super()._map_serializer(
            serializer_instance, direction, bypass_extensions
        )
