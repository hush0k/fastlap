...
class DriverListSerializer(ModelSerializer):
    nationality_name: SerializerMethodField = SerializerMethodField()
...
class DriverResultSerializer(ModelSerializer):
    driver: SerializerMethodField = SerializerMethodField()
    race: SerializerMethodField = SerializerMethodField()
