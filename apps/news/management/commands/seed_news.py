        ...
        articles = [
            {
                ...
                "content": "Max Verstappen delivered yet another masterclass performance at the Bahrain International Circuit, leading from start to finish to claim victory in the opening round of the Formula 1 World Championship. "
                * 5,
                "is_published": True,
            ...
            },
            {
                ...
                "content": "In one of the most shocking moves in Formula 1 history, seven-time world champion Lewis Hamilton has confirmed he will join Scuderia Ferrari for the 2025 season, ending his long-standing partnership with Mercedes. "
                * 5,
                "is_published": True,
                "published_at": timezone.now(),
                "tags": ["F1", "Car"],
            },
            {
                ...
                "content": "The 24 Hours of Le Mans is set to deliver another classic with a record number of entries and several manufacturers battling for overall honours at the famous Circuit de la Sarthe this weekend. "
                * 5,
                "is_published": True,
                "published_at": timezone.now(),
